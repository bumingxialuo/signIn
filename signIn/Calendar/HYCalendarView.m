...
//    [self addSubview:headlabel];
    ...
    weekBg.frame = CGRectMake(0, 0, self.frame.size.width, 27);
    ...
    for (int i = 0; i < 42; i++) {
        ...
        dayIMG.image = [UIImage imageNamed:@"duigou"];
//        selectedIMG.hidden = true;
        
        UILabel *dayLabel = _againDuigouArray[i];
        dayLabel.frame = CGRectMake(x+10, y+32, 26, 14);
        dayLabel.text = @"补签";
...
#pragma mark 设置已经签到
- (void)setSign:(int)i andBtn:(UIButton*)dayButton imageView: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
...
- (void)setDuigouStyle_BeyondThisMonth: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
    imgView.hidden = true;
...
- (void)setDuigouStyle_BeforeToday: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
    imgView.hidden = YES;
...
- (void)setDuigouStyle_Today: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
    imgView.hidden = YES;
    againLabel.hidden = NO;
    againLabel.text = @"签到";
}
...
- (void)setDuigouStyle_AfterToday: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
    imgView.hidden = YES;
    againLabel.hidden = YES;
}
...
- (void)setDuigouStyle_SignEd: (UIImageView *)imgView againLabel: (UILabel *) againLabel {
    imgView.hidden = NO;
    againLabel.hidden = YES;
}
